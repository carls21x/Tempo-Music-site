const cancionesFavoritas = [
    ...
    { titulo: "Somebody Told Me", artista: "The Killers", img: "resources/hotfuss.jpeg" },
    { titulo: "Morph", artista: "twenty one pilots", img: "resources/trench.jpg" }
];

const albumesFavoritos = [
    { titulo: "Trench", artista: "twenty one pilots", img: "resources/trench.jpg" },
    { titulo: "Favourite Worst Nightmare", artista: "Arctic Monkeys", img: "resources/fwn.jpeg" },
    { titulo: "Oracular Spectacular", artista: "MGMT", img: "artistas/mgmt.jpg" },
